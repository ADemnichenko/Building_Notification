...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        MainWindow.resize(449, 480)
        MainWindow.setMinimumSize(QtCore.QSize(449, 480))
        MainWindow.setMaximumSize(QtCore.QSize(449, 480))
...
"}")
        ...
        self.tabWidget.setMaximumSize(QtCore.QSize(411, 422))
...
"")
        ...
        self.frame_5.setGeometry(QtCore.QRect(0, 10, 415, 421))
...
"}")
        ...
        self.fld_proj_path.setMinimumSize(QtCore.QSize(301, 31))
...
"")
        ...
        self.label_3.setMinimumSize(QtCore.QSize(91, 16))
        self.label_3.setMaximumSize(QtCore.QSize(91, 16))
        self.label_3.setStyleSheet("QLabel{    color: rgb(203, 203, 203);}")
        ...
        self.fld_proj_name.setMinimumSize(QtCore.QSize(221, 31))
        self.fld_proj_name.setMaximumSize(QtCore.QSize(221, 31))
...
"}")
        ...
        self.gridLayout_4.addWidget(self.fld_proj_name, 0, 2, 1, 1)
...
"padding: 5px;\n"
"}")
        self.fld_password.setEchoMode(QtWidgets.QLineEdit.Normal)
        ...
        spacerItem2 = QtWidgets.QSpacerItem(191, 8, QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Minimum)
...
"}")
        ...
        self.frame_8 = QtWidgets.QFrame(self.notification)
        self.frame_8.setGeometry(QtCore.QRect(0, 10, 421, 428))
...
"")
        ...
        self.fld_ipa_or_pak_dir.setMinimumSize(QtCore.QSize(301, 31))
        self.fld_ipa_or_pak_dir.setMaximumSize(QtCore.QSize(301, 31))
...
"")
        ...
        self.groupBox_6.setMinimumSize(QtCore.QSize(391, 190))
        self.groupBox_6.setMaximumSize(QtCore.QSize(391, 190))
...
"")
        ...
        self.pb_parse_log = QtWidgets.QProgressBar(self.frame_7)
        self.pb_parse_log.setMinimumSize(QtCore.QSize(200, 10))
        self.pb_parse_log.setMaximumSize(QtCore.QSize(200, 20))
        self.pb_parse_log.setStyleSheet("QProgressBar {\n"
"    color: rgb(80, 80, 80);\n"
...
"    width: 10px;\n"
"}")
        self.pb_parse_log.setProperty("value", 50)
        self.pb_parse_log.setObjectName("pb_parse_log")
        self.gridLayout_13.addWidget(self.pb_parse_log, 0, 2, 1, 1)
        self.checkBox_4 = QtWidgets.QCheckBox(self.frame_7)
        self.checkBox_4.setMinimumSize(QtCore.QSize(108, 31))
        self.checkBox_4.setMaximumSize(QtCore.QSize(108, 31))
...
"}")
        ...
        self.gridLayout_13.addWidget(self.checkBox_4, 3, 0, 1, 1)
        self.pb_unpak_pak = QtWidgets.QProgressBar(self.frame_7)
        self.pb_unpak_pak.setMinimumSize(QtCore.QSize(200, 20))
        self.pb_unpak_pak.setMaximumSize(QtCore.QSize(200, 20))
        self.pb_unpak_pak.setStyleSheet("QProgressBar {\n"
"    color: rgb(80, 80, 80);\n"
"    border: 1px solid grey;\n"
"    border-radius: 5px;\n"
"    text-align: center;\n"
...
"    width: 10px;\n"
"}")
        self.pb_unpak_pak.setProperty("value", 50)
        self.pb_unpak_pak.setObjectName("pb_unpak_pak")
        self.gridLayout_13.addWidget(self.pb_unpak_pak, 2, 2, 1, 1)
        self.pb_extract_ipa = QtWidgets.QProgressBar(self.frame_7)
        self.pb_extract_ipa.setMinimumSize(QtCore.QSize(200, 20))
        self.pb_extract_ipa.setMaximumSize(QtCore.QSize(200, 20))
        self.pb_extract_ipa.setStyleSheet("QProgressBar {\n"
"    color: rgb(80, 80, 80);\n"
"    border: 1px solid grey;\n"
"    border-radius: 5px;\n"
"    text-align: center;\n"
...
"    width: 10px;\n"
"}")
        self.pb_extract_ipa.setProperty("value", 50)
        self.pb_extract_ipa.setObjectName("pb_extract_ipa")
        self.gridLayout_13.addWidget(self.pb_extract_ipa, 1, 2, 1, 1)
        self.checkBox_3 = QtWidgets.QCheckBox(self.frame_7)
        self.checkBox_3.setMinimumSize(QtCore.QSize(108, 31))
        self.checkBox_3.setMaximumSize(QtCore.QSize(108, 31))
...
"}")
        ...
        self.gridLayout_13.addWidget(self.checkBox_3, 2, 0, 1, 1)
        self.checkBox = QtWidgets.QCheckBox(self.frame_7)
        self.checkBox.setMinimumSize(QtCore.QSize(108, 31))
        self.checkBox.setMaximumSize(QtCore.QSize(108, 31))
...
"}")
        ...
        self.pb_get_size = QtWidgets.QProgressBar(self.frame_7)
        self.pb_get_size.setMinimumSize(QtCore.QSize(200, 20))
        self.pb_get_size.setMaximumSize(QtCore.QSize(200, 20))
        self.pb_get_size.setStyleSheet("QProgressBar {\n"
"    color: rgb(80, 80, 80);\n"
"    border: 1px solid grey;\n"
"    border-radius: 5px;\n"
"    text-align: center;\n"
...
"    width: 10px;\n"
"}")
        self.pb_get_size.setProperty("value", 50)
        self.pb_get_size.setObjectName("pb_get_size")
        self.gridLayout_13.addWidget(self.pb_get_size, 3, 2, 1, 1)
        self.checkBox_2 = QtWidgets.QCheckBox(self.frame_7)
        self.checkBox_2.setMinimumSize(QtCore.QSize(108, 31))
        self.checkBox_2.setMaximumSize(QtCore.QSize(108, 31))
...
"}")
        ...
        self.frame_10.setMinimumSize(QtCore.QSize(397, 60))
        self.frame_10.setMaximumSize(QtCore.QSize(397, 60))
...
"}")
        ...
        self.gridLayout_16.addWidget(self.btn_cancel, 0, 2, 1, 1)
...
"}")
        ...
        self.gridLayout_16.addWidget(self.btn_start, 0, 0, 1, 1)
        spacerItem6 = QtWidgets.QSpacerItem(40, 20, QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Minimum)
        self.gridLayout_16.addItem(spacerItem6, 0, 1, 1, 1)
        self.gridLayout_17.addWidget(self.frame_9, 0, 1, 1, 1)
        spacerItem7 = QtWidgets.QSpacerItem(174, 2, QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Minimum)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.groupBox.setTitle(_translate("MainWindow", "Project Directory"))
        self.btn_proj_dir.setText(_translate("MainWindow", "..."))
        self.fld_proj_path.setText(_translate("MainWindow", "Select Project Directory"))
        self.groupBox_3.setTitle(_translate("MainWindow", "Project Name"))
        self.label_3.setText(_translate("MainWindow", "Project Name :"))
        self.fld_proj_name.setText(_translate("MainWindow", "Enter Project Name"))
        self.groupBox_2.setTitle(_translate("MainWindow", "Authorization"))
        self.label.setText(_translate("MainWindow", "Email :"))
        self.fld_email.setText(_translate("MainWindow", "Enter Email"))
        self.fld_password.setText(_translate("MainWindow", "Enter Password"))
        ...
        self.fld_ipa_or_pak_dir.setText(_translate("MainWindow", "Select IPA or PAK Directory"))
        ...
        self.checkBox_4.setText(_translate("MainWindow", "Get Size"))
        self.checkBox_3.setText(_translate("MainWindow", "Unpak PAK"))
        self.checkBox.setText(_translate("MainWindow", "Parse Log"))
        self.checkBox_2.setText(_translate("MainWindow", "Extract IPA"))
